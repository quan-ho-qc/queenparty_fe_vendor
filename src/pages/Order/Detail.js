...
class Detail extends Component {
  ...
  componentDidMount() {
    axios
      .get("order_detail/" + this.state.user_id + "/" + this.state.vendor_id)
      .then((res) => {
        this.setState({
          orders: res.data[0],
        });
  ...
  acceptProduct(id) {
    axios
      .put("admin_order/" + id, { status: "ĐH đang xử lí" })
      .then(() => {
  ...
  refusedProduct(id) {
    axios
      .put("admin_order/" + id, { status: "ĐH từ chối" })
      .then(() => {
  ...
  successProduct(id) {
    axios
      .put("admin_order/" + id, { status: "ĐH thành công" })
      .then(() => {
              ...
              <div className="content-wrapper">
                <div className="page-header">
                  <h3 className="page-title">
                    ...
                    Quản Lí Đơn Hàng - Chi Tiết Đơn Hàng
                  </h3>
                ...
                <div className="card">
                  <div className="card-body">
                    <span>
                      <button
                        type="button"
                        onClick={() =>
                          this.acceptProduct(this.props.location.state.id)
                        }
                      ...
                      <button
                        type="button"
                        onClick={() => this.refusedProduct(this.state.id)}
                  ...
                  <div className="card-body">
                    ...
                    <table className="table table-bordered">
                      ...
                      <p></p>
                      <h6>
                        Thành tiền: {this.state.total.toLocaleString()} VND
                      </h6>
                    </table>
                  </div>
                </div>
                ...
                <div className="card">
                  <div className="card-body">
                    <span>
                      <button
                        type="button"
                        onClick={() => this.successProduct(this.state.id)}
